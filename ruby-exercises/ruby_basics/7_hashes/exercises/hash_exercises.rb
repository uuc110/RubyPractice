def create_favorite_hash(color, number)
  # 1. return a hash with the following key/value pairs:
  {color: color, number: number}
  # 2.  key of color (as a symbol) with value of the color argument
  # 3. key of number (as a symbol) with the value of the number argument
...
def favorite_number(favorite_list)
  ...
  favorite_list.fetch(42.values, 42)
end
